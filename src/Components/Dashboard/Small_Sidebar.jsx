...
function Small_Sidebar({
  ...
  return (
    <div className='sidebar absolute flex flex-col lg:hidden pl-2 min-w-fit' style={{ background: "rgba(33, 93, 79, 1)" }}>
      
      <ul className="relative flex flex-col gap-4 whitespace-nowrap min-w-full mt-20  px-2">
        <li
          className={
        ...
        <li className="w-fit">
          <ul className="gap-3 mt-2 whitespace-nowrap w-60">
            ...
            <li className={act_sub_st === "Fund Transfer" ? "text-orange-300 font-medium hover:cursor-pointer  py-2 whitespace-nowrap flex flex-row justify-between items-center w-full"
              ...
              <div className="w-full relative mt-48">
      <img src={bottom} alt="sidebar-bottom-design" className="absolute bottom-0 right-0 " /></div>
    </div>
  )
}
...
const mapStateToProps = (state) => ({
  ...
  export default connect(mapStateToProps)(Small_Sidebar);

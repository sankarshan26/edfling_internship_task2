...
function MyClassroomSmallSidebar({ act_st,  handle_act_st,  act_sub_st,  handle_sub_act_st,}) {
  return (
    <div className='sidebar absolute flex flex-col lg:hidden z-50 min-w-fit' style={{"background": "rgba(33, 93, 79, 1)"}}>
      <div className="sidebar_heading relative w-fit px-4 py-4 mt-4 ml-8">
      ...
      <div className="flex-1 flex flex-col justify-between mx-8">
      <ul className="mt-6 mb-56 w-fit ">
        <li
          className={
            act_st === "Courses"
      ...
      {/* <div className="sidebar-img  mt-0  flex w-full overflow-hidden " >
        <img src={Sidebar_img2} alt="" />
        <img src={Sidebar_img} alt="Sidebar_img" className=''/>
      </div> */}
...
export default connect(mapStateToProps)(MyClassroomSmallSidebar) ;

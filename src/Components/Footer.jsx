  ...
  return (
    <>
      ...
      <div className="footer-cont w-full flex flex-col items-center pt-5  space-y-2 md:space-y-4 opacity-90 mt-8">
        ...
        {/* middle */}
        <div className="middle py-5 flex flex-col md:flex-row flex-wrap lg:flex-nowrap w-4/5 items-center justify-evenly md:justify-center gap-y-8 gap-x-14">
          ...
          <span className="line  lg:block ">&nbsp;</span>
          <ul className="gap-3 flex flex-col items-left">
